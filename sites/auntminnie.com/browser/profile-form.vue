...
import regionCountryCodes from '@parameter1/base-cms-marko-web-identity-x/browser/utils/region-country-codes';

import AddressBlock from '@parameter1/base-cms-marko-web-identity-x/browser/form/address-block.vue';
...
import GivenName from '@parameter1/base-cms-marko-web-identity-x/browser/form/fields/given-name.vue';
import FamilyName from '@parameter1/base-cms-marko-web-identity-x/browser/form/fields/family-name.vue';
import Organization from '@parameter1/base-cms-marko-web-identity-x/browser/form/fields/organization.vue';
import OrganizationTitle from '@parameter1/base-cms-marko-web-identity-x/browser/form/fields/organization-title.vue';
import Country from '@parameter1/base-cms-marko-web-identity-x/browser/form/fields/country.vue';
import PhoneNumber from '@parameter1/base-cms-marko-web-identity-x/browser/form/fields/phone-number.vue';
...
import AutoSignupEventEmitter from '@parameter1/base-cms-marko-web-identity-x/browser/mixins/global-auto-signup-event-emitter';
